...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: condVar = zeros  (sizeInBytes=16)
	load	[r14+8],r4
	add	r4,28,r4
	store	r0,[r4]
	store	r0,[r4+4]
...
!   _temp_146 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-52]
!   Move address of _temp_146 [l ] into _temp_147
!     make sure index expr is >= 0
	load	[r14+-84],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_149 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-40]
!   Move address of _temp_149 [r ] into _temp_150
!     make sure index expr is >= 0
	load	[r14+-88],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_202 = 4		(4 bytes)
	...
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
!   Data Move: p = _temp_201  (sizeInBytes=4)
	load	[r14+-40],r1
	store	r1,[r14+-44]
_Label_197:
!   Perform the FOR-LOOP termination test
!   if p > _temp_202 then goto _Label_200		
	load	[r14+-44],r1
	load	[r14+-36],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-24]
!   Data Move: _temp_208 = *_temp_210  (sizeInBytes=4)
	load	[r14+-24],r1
	load	[r1],r1
	store	r1,[r14+-32]
